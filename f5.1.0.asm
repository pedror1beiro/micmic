...
jmp roleta
dis2:
ldi r16, 0b10000000        ; Configura PORTD para sw's + escolha disp
    out DDRD, r16
	jmp roleta

dis1:
ldi r16, 0b01000000        ; Configura PORTD para sw's + escolha disp
    out DDRD, r16
	jmp roleta

dis0:
ldi r16, 0b00000000        ; Configura PORTD para sw's + escolha disp
    out DDRD, r16
	jmp roleta
...
parar_piscar:
    ...
    jmp displayagora                    ; Fim do ciclo de piscar
